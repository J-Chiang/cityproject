...
{
    /// <summary>
    /// Represents object that stores dTrequest parameters sent by <a href="https://datatables.net/">DataTables.net</a> library.
    ...
    public class DataTablesRequest<T>
    {
        ...
        /// <code>
        /// // Get DataTables dTrequest from Http query parameters
        /// var dTrequest = new DataTablesRequest&lt;Student&gt;(url); 
        /// 
        /// // Access by property name
        /// var column = dTrequest.Columns["FirstName"];
        /// 
        /// // Access by property selector
        /// var column = dTrequest.Columns[s => s.FirstName];
        /// </code>
        /// </example>
        ...
        /// <summary>
        /// Set this property to log incoming dTrequest parameters and resulting queries to the given delegate. 
        ...
        /// <summary>
        /// Original dTrequest parameters collection
        /// </summary>
        public NameValueCollection OriginalRequest { get; private set; } = null;

        /// <summary>
        /// Gets original dTrequest parameter value by its name
        /// </summary>
        /// <param name="parameterName">Name of original dTrequest parameter</param>
        /// <returns>String value of original dTrequest parameter</returns>
